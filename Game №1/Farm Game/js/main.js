...
var GameState = {
    ...
    preload: function() {
        ...
        this.load.audio('FarmMusic', 'assets/audio/old_town_road.mp3');
    },
    ...
    create: function() {
        ...
        this.music = this.game.add.audio('FarmMusic');
        this.music.play();
        ...
        //create a group to store all animals, var, let, this, timeout, інтервал, phaser інтервал
        ...
        animalData.forEach(function(element){
            ...
            animal.animations.add('animate', [0, 1, 2, 1, 0, 1], 3, true);
            animal.play('animate');
